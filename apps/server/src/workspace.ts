...
export class WorkspaceManager {
  ...
  async writeInstructions(agent: Agent): Promise<void> {
    const content = [
      ...
      "",
      "## NawGate protected actions",
      "",
      "Some downstream resources are protected by NawGate and are not directly available in this workspace.",
      "",
      ...
      "For synthetic TikTok content actions, use only registered assets:",
      "- agentctl content moderate <asset-id>",
      "- agentctl content disclose <asset-id>",
      "- agentctl content publish <asset-id>",
      "- agentctl content export <asset-id>",
      "",
